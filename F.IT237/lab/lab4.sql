...
SELECT * FROM information_schema.table_constraints
	WHERE Table_name = 'Zahialagch' and table_schema = 'lab4';
...
SELECT * FROM information_schema.table_constraints
	WHERE Table_name = 'Nom' and table_schema = 'lab4';

SELECT * FROM information_schema.table_constraints
	WHERE Table_name = 'ZahialgiinDelgerengvi' and table_schema = 'lab4';
...
SELECT * FROM information_schema.table_constraints
WHERE Table_name = 'Tulbur' and table_schema = 'lab4';
...
SELECT * FROM information_schema.table_constraints
WHERE Table_name = 'Ajiltan' and table_schema = 'lab4';
...
insert into Ajiltan values
("A001", "Галбадрах Номин", "эм", "99892988", "БЗД 3хороо","ЗХ99120834", "nomin1234", "nn9819", "CA",3),
("A002", "Содном Одгэрэл" , "эм", "89983421", "БГД 2хороо","ЗХ97121824", "odgerel", "gerlee21", "CA", 3),
...
(null, "2023-01-12 12:19:00", null, 1, 1, "A001"),
...
(null, "2023-04-02 17:50:00", null, 6, 1, "A004"),
(null, "2023-07-18 18:10:00", null, 7, 1, "A001"),
(null, "2023-07-12 19:50:00", null, 8, 1, "A008"),
(null, "2023-08-11 14:59:00", null, 9, 1, "A009"),
(null, "2023-08-12 15:43:00", null, 10,1, "A008");
...
SELECT * FROM information_schema.table_constraints
WHERE Table_name = 'Ajiltan' and table_schema = 'lab4';
-- -------------------------------- Ajiltan husnegtiin AjiltanAngilal husnegttei holbogdson fk ustgaw
alter table Ajiltan
drop constraint fk_Ajiltan_AjiltanAngilal;
-- -------------------------------- CASCADE ------------------------------------
ALTER TABLE Ajiltan
ADD CONSTRAINT fk_Ajiltan_AjiltanAngilal
FOREIGN KEY(Angilal_AngilalCode) REFERENCES AjiltanAngilal(AngilalCode) ON UPDATE CASCADE;

select * from Ajiltan;
select * from AjiltanAngilal;
-- ----------------------CASCADE ued UPDATE hiij uzew
update AjiltanAngilal
set AngilalCode=10
where AngilalCode=3;
-- -------------------------------- Tulbur husnegtiin TulburHelber husnegttei holbogdson fk ustgaw
desc TulburHelber;
desc Tulbur;
SELECT * FROM information_schema.table_constraints
WHERE Table_name = 'Tulbur' and table_schema = 'lab4';
...
ALTER TABLE Tulbur
drop constraint tulbur_ibfk_1;

ALTER TABLE Tulbur
ADD CONSTRAINT tulbur_ibfk_1
foreign key(TulburHelber_TulburHelber_id) references TulburHelber(TulburHelber_id) ON DELETE CASCADE;
select * from TulburHelber;
select * from Tulbur;
-- ----------------------CASCADE ued DELETE hiij uzew
delete from TulburHelber
where TulburHelber_id=3;

-- -------------------------------- Ajiltan husnegtiin AlbanTushaal husnegttei holbogdson fk ustgaw
desc Ajiltan;
desc AlbanTushaal;
select * from information_schema.table_constraints
WHERE Table_name = 'Ajiltan' and table_schema = 'lab4';
...
alter table Ajiltan
drop constraint ajiltan_ibfk_1;

alter table Ajiltan 
modify AlbanTushaal_AlbanTushaalCode varchar(2) null;
-- ----------------------------- set null ------------------
alter table Ajiltan
add constraint fk_Ajiltan_AlbanTushaal
foreign key(AlbanTushaal_AlbanTushaalCode) references AlbanTushaal(AlbanTushaalCode) on delete set null
on update set null;

select * from Ajiltan;
select * from AlbanTushaal;

delete from AlbanTushaal
where AlbanTushaalCode="CA";

update AlbanTushaal
set AlbanTushaalCode="CA"
where AlbanTushaalCode="HV";
...
alter table Ajiltan
drop constraint fk_Ajiltan_AlbanTushaal;

alter table Ajiltan
add constraint fk_Ajiltan_AlbanTushaal
foreign key(AlbanTushaal_AlbanTushaalCode) references AlbanTushaal(AlbanTushaalCode) on delete no action
on update no action;
...
update AlbanTushaal
set AlbanTushaalNer="Manager"
where AlbanTushaalCode="ME";

update Ajiltan
set AlbanTushaal_AlbanTushaalCode = "MA"
where AlbanTushaal_AlbanTushaalCode="ME";

update Ajiltan
set AjiltanHvis = "эр"
where AlbanTushaal_AlbanTushaalCode="MA";
...
alter table Ajiltan
add constraint fk_Ajiltan_AlbanTushaal
foreign key(AlbanTushaal_AlbanTushaalCode) references AlbanTushaal(AlbanTushaalCode) on delete restrict
on update restrict;
...
update AlbanTushaal
set AlbanTushaalCode="RA"
where AlbanTushaalCode="ME";
-- -------------------------- ygd ch ym ajillaad bga
update AlbanTushaal
set AlbanTushaalNer="МЕНЕЖЕР"
where AlbanTushaalCode="ME";
...
delete from Ajiltan
where AlbanTushaal_AlbanTushaalCode = "BO";